...
class File {
  ...
  const File({required this.fileTitle, required this.fileUrl});
}

class CompetitionListButtons extends StatelessWidget {
  final List<Competition> competitions;

  const CompetitionListButtons({super.key, required this.competitions});
...
class FileListButtons extends StatelessWidget {
  ...
  const FileListButtons({super.key, required this.files});
...
class ColonneLinks extends StatefulWidget {
  ...
  const ColonneLinks({super.key, required this.fraction, required this.size});
